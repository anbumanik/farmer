...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-xl transition-all duration-300 group flex flex-col pt-3 relative active:scale-95 transform">
      ...
      {/* Wishlist Button */}
      <button className="absolute top-2 right-2 border border-gray-200 rounded-full p-1.5 bg-white text-gray-400 hover:text-red-500 z-10 transition z-10">
        <Heart size={16} />
      </button>
      ...
      <div className="p-4 flex flex-col flex-1 border-t border-gray-100 bg-white">
        ...
        <div className="flex items-end justify-between mt-auto">
          ...
          <button 
            ...
            disabled={isAdding}
            className="bg-[#D4AF37] hover:bg-[#166534] text-white text-xs font-bold px-4 py-2 rounded-full cursor-pointer flex items-center justify-center gap-1 transition disabled:opacity-75"
          >
            {isAdding ? (
